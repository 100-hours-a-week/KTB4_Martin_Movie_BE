...
import com.homework4.workapi.auth.JwtAuthenticationFilter;
        ...
        http
                ...
                .exceptionHandling(exception -> exception
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            CommonResponse<Void> commonResponse = CommonResponse.of("UNAUTHORIZED", null);
                        ...
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            ...
                            CommonResponse<Void> commonResponse = CommonResponse.of(
                                    "FORBIDDEN",
                                    null
                            );
